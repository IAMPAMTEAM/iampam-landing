    ...
    return (
      <div className="site-footer-two  go-top">
            ...
            <div className="row">
              <div className="col-xl-3 col-lg-6">
                <div className="footer-widget footer-widget__about">
                  ...
                  <p>
                    But we must ipsum dolor sit amet con sectetur adipisicing elit sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
                    Ut enim ad minim
                  </p>
                  <div className="footer-widget__social">
                    ...
                    <a href="https://behance.com/webtend">
                ...
                <div className="footer-widget footer-widget__post">
                  ...
                  <div className="footer-widget__post-wrap">
                    <div className="footer-widget__post-single">
                      <h3>
                        <Link to="/blog-details">Everything You Need Know About Alignment In Flexbox</Link>
                      </h3>
                      <div className="footer-widget__post-meta">
                        <Link to="/blog-details">
                          By <span>Zekio Alex</span>
                        </Link>
                        <Link to="/blog-details">
                          Date <span>20 Dec 2019</span>
                        </Link>
                      </div>
                    ...
                    <div className="footer-widget__post-single">
                      <h3>
                        <Link to="/blog-details">Web Performance For Third Party Scripts: Smashing Cone.</Link>
                      </h3>
                      <div className="footer-widget__post-meta">
                        <Link to="/blog-details">
                          By <span>Zekio Alex</span>
              ...
              <div className="col-xl-3 col-lg-6">
                <div className="footer-widget footer-widget__links">
                  ...
                  <ul className="footer-widget__links-list list-unstyled">
                    ...
                    <li>
                      <Link to="/about">Setting &amp; Privecy</Link>
                    </li>
                    <li>
                      <Link to="/contact">Need a Job?</Link>
                    </li>
                    <li>
                      <Link to="/blog-grid">Latest Blog</Link>
                    </li>
                    <li>
              ...
              <div className="col-xl-3 col-lg-6">
                <div className="footer-widget footer-widget__contact">
                  ...
                  {/* /.footer-widget__title */}
                  <p>Subscribe our newsletters to get more update and many more</p>
        ...
        <div className="site-footer-two__bottom">
          <div className="container">
            <p>
              Copy@2022 <a href="#">Bizkar</a>. All Right Reserved.
            </p>
          </div>
          {/* /.container */}
        </div>
